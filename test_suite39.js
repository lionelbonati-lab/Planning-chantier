...
(async () => {
  ...
  // --- 1 à 6. Ordinateur : onglet, enregistrement, impression ---
  {
    ...
    verifier(blocs.actif && blocs.legendes.join() === 'Page,Marges,Espacements,En-tête,Pied de page', 'onglet : Page, Marges, Espacements, En-tête, Pied de page (' + blocs.legendes.join() + ')');
    ...
    verifier(defauts === 'orientation=paysage taille=normale marges.haut=12 marges.bas=12 marges.gauche=12 marges.droite=12 espaces.personnes=1.6 espaces.sections=3.7 espaces.cases=1.3 espaces.legende=3.7 entete.texte= entete.chantier=true entete.date=false pied.page=true pied.date=true pied.texte=',
